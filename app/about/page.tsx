...
const About = () => {
  return (
    <main className='flex flex-col px-4 md:px-16 md:justify-start md:items-end mt-2 md:mt-[8rem]'>
      ...
      <div className="w-full text-center  flex flex-col justify-center items-center pt-4 md:pt-8 sxl:items-end sxl:pt-16">
